      ...
      >
          ...
          <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
              ...
              <div className='flex-1'>
                  <p className='mb-10 max-w-2xl font-Ovo'>I am a passionate and dedicated student pursuing a Bachelor’s degree in Computer Science and Information Technology (BCA). My primary focus is on full-stack development, with a strong interest in building innovative and user-friendly web applications.
                    Currently, I am honing my skills in front-end development, working with modern frameworks and tools to create visually appealing and responsive interfaces. I am eager to expand my expertise and grow into a versatile full-stack developer, committed to delivering impactful digital solutions.</p>
